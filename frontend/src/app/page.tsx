...
import { Play, Zap, Shield, FileText, ArrowUpRight, Github, Linkedin, Youtube, AlertTriangle, Network, Search, GitGraph, Scissors, BarChart3, Fingerprint } from "lucide-react";
      ...
      <footer className="border-t border-white/[0.05] mt-10">
         <div className="max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
           ...
           <div className="flex items-center gap-4">
              ...
              <a href="#" className="text-white/40 hover:text-white transition-colors"><Linkedin className="w-4 h-4" /></a>
              <a href="#" className="text-white/40 hover:text-white transition-colors"><Youtube className="w-4 h-4" /></a>
           </div>
         </div>
